...
const sidebars: SidebarsConfig = {
  sparkSidebar: {
    ...
    'spark misc': ['misc/spark-vs-others', 'misc/Using-async-profiler', 'misc/About-spark-metrics', 'misc/Raw-spark-data', 'misc/Placeholders', 'misc/Info-points', 'misc/Credits']
  },
};
